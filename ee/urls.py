...
from ee.admin.loginas_views import (
    get_impersonation_ticket,
    loginas_user,
    loginas_user_from_ticket,
    upgrade_impersonation,
)
...
if settings.ADMIN_PORTAL_ENABLED:
    ...
    admin_urlpatterns = [
        ...
        path("admin/impersonation/ticket/", get_impersonation_ticket, name="impersonation-ticket"),
