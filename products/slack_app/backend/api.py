...
from products.tasks.backend.repo_selection.classifier import classify_task_needs_repo as _classify_task_needs_repo
...
def classify_task_needs_repo(
    ...
    Thin wrapper over the shared chat-bridge classifier, pinned to the Slack
    LLM-gateway product tag. See products/tasks/backend/repo_selection/classifier.py.
    """
    return _classify_task_needs_repo(event_text, thread_messages, product="slack_app_routing")
