...
CREATE MATERIALIZED VIEW posthog.property_values_daily_mv TO posthog.property_values_daily (team_id Int64, property_type LowCardinality(String), property_key String, property_value String, day Date) AS SELECT
  team_id,
  property_type,
  property_key,
  property_value,
