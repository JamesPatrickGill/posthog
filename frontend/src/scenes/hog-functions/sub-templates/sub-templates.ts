...
const MCP_TOOL_ERROR_MESSAGE =
    '*{event.properties.$mcp_tool_name}* failed on your MCP server *{event.properties.$mcp_server_name}* ' +
                ...
                blocks: {
                    value: [
                        { type: 'section', text: { type: 'mrkdwn', text: MCP_TOOL_ERROR_MESSAGE } },
                        {
                            ...
                            elements: [
                                {
                                    url: '{project.url}/mcp-analytics/tool-quality/{event.properties.$mcp_tool_name}',
